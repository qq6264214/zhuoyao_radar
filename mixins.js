...
module.exports = {
  ...
  computed: {
    max_range(){
      return  this.settings.wide_range * 2 + 1
    }
  },
  methods: {
    /**
    ...
    getNextPosition() {
      ...
      if (this.lat_count < this.max_range) {
        let _lat = (this.lat_count - this.settings.wide_range) * WS.LAT_RANGE;
        let _lng = (this.lng_count - this.settings.wide_range) * WS.LNG_RANGE;
