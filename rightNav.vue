      ...
      <div class="side-nav" v-show="showMenu">
        ...
        <div class="side-content">
          <div class="nav-filter">
            ...
            <ul>
              <li>
                <span class="tag">大范围模式</span>
                <el-switch v-model="isWideMode"></el-switch>
              </li>
              <li v-if="mode === 'wide'">
                <div></div>
                <label class="tag">搜索范围: {{settings.wide_range}}</label>
                <el-slider v-model="settings.wide_range" :max="10" :min="1" :step="1" style="float:right;width:50%;margin-top: -8px;margin-right: 2px;margin-right: 8px;"></el-slider>
              </li>
